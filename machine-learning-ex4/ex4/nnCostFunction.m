...
a1 = [ones(m, 1) X];
% ones(m, 1) is bais unit. it's used to calcular unit input after'.
z2 = a1 * Theta1';
...
% y_matrix is matrix one-hot forme
y_matrix = eye(num_labels)(y,:);

% Cost function
J = (1 / m) * sum(sum(-y_matrix .* log(h_theta_x) - (1 - y_matrix) .* log(1 - h_theta_x)));
